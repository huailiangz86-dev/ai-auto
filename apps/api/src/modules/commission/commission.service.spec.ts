    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: DataSource, useValue: dataSource },
        {
          ...
          useValue: { awardForRedemption: jest.fn().mockResolvedValue([]) },
        },
        {
          provide: SharingTaskService,
          useValue: { trackRedemption: jest.fn().mockResolvedValue(undefined) },
        },
        { provide: PilotInstrumentationService, useValue: { recordVerifiedRedemption: jest.fn().mockResolvedValue(undefined) } },
      ],
    }).compile()
